      ...
      >
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            <div className="text-[10px] font-mono uppercase tracking-[0.06em] text-white/80 dark:text-primary-foreground/80 font-medium">
              {isNewLearner ? "First Challenge" : "Active Frontier"}
            </div>
            <div className="text-xs truncate font-bold text-white dark:text-primary-foreground">
              {lesson.title}
            </div>
          </div>
        </div>
